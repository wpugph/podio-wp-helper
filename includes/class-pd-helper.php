...
class PD_helper {
	...
	/**
	 * The single instance of PD_helper.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function register_post_type ( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new PD_helper_Post_Type( $post_type, $plural, $single, $description, $options );
	...
	public function register_taxonomy ( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new PD_helper_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
	...
	public function load_localisation () {
		load_plugin_textdomain( 'pd-helper', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
	...
	/**
	 * Main PD_helper Instance
	 *
	 * Ensures only one instance of PD_helper is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see PD_helper()
	 * @return Main PD_helper instance
	 */
